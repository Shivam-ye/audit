...
class ResourceService:
    """Service for extracting resource information - business logic moved from ResourceExtractor"""

    @staticmethod
    def extract_resource(payload: dict, validated: Any, payload_type: str) -> tuple[str, str, dict]:
        """
        Extract resource information from various payload formats.
        ...
        Returns:
            Tuple of (resource_id string, resource_type string, data dict)
        """
